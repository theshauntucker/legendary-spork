...
const faqs = [
  ...
  },
  {
    ...
    a: "Your first analysis is just $1.99 — less than your morning coffee. After that, BOGO is 2 for $2.99, the Competition Pack is 5 for $9.99 ($1.99 each), or go monthly with Season Member at $4.99/mo for 4 analyses.",
  },
  {

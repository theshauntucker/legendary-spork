...
import { Check, ArrowRight, Gift, Zap, Clock } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="mt-2">
              ...
              <p className="text-sm text-surface-200 mb-6">Two full AI analyses. Use them on different routines or analyze the same one twice to track your progress.</p>
            </div>
            <ul className="space-y-3 mb-8">
              {["2 full AI analyses included", "Competition-standard scoring (Gold → Diamond)", "Timestamped judge notes", "Improvement roadmap", "Results in under 5 minutes"].map((item) => (
          ...
          >
            ...
            <div className="mt-2">
              ...
              <p className="text-sm text-surface-200 mb-6">5 full AI analyses. Track the same routine week by week or cover multiple dancers across a season.</p>
            </div>
            <ul className="space-y-3 mb-8">
